 ...
 * @param {string} userData.phone - O telefone do usuário (opcional).
 ...
 * @param {number} userData.role - O papel do usuário (1 = Customer, 0 = Admin, 2 = Provider).
...
export async function registerUser({ userName, name, email, phone, password, passwordConfirmation, role }) {
  ...
  const params = new URLSearchParams({
    ...
    Role: role, // 👈 agora aceita o valor numérico do enum
  });
