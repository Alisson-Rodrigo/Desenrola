...
namespace Desenrola.Domain.Exception;
...
public abstract class ApiException : System.Exception
{
    ...
    /// <summary>
    /// The errors that caused the <see cref="ApiException"/> to be raised
    /// </summary>
    public List<string> Errors { get; set; } = [];

    /// <summary>
    /// Returns a formatted message containing all error messages
    /// </summary>
