...
import Navbar from "../../../components/Navbar"; // ✅ mesma importação usada em Visualizar

const SolicitacaoServicos = () => {
  // 🔹 Valores iniciais simulados (estáticos)
  const [formData, setFormData] = useState({
    categoria: "Eletricista",
    titulo: "Troca de disjuntor",
    descricao:
      "Preciso da troca de um disjuntor que está queimado no quadro de energia.",
        ...
        <header className={styles.header}>
          <div className={styles.headerContent}>
            ...
            <p className={styles.pageSubtitle}>
              Você está solicitando o serviço de{" "}
              <strong>Pedro Eletricista ⚡</strong>
            </p>
          </div>
        </header>
          ...
          <form onSubmit={handleSubmit} className={styles.solicitacaoForm}>
            <div className={styles.formStep}>
              <div className={styles.stepHeader}>
                ...
                <p>
                  Verifique as informações e ajuste se necessário antes de
                  enviar.
                </p>
              </div>
